...
// This program implements a simple C++ game that allows the user to 
// enter xy-coordinates in order to "zap" bugs off the graphics window. 
// The number of zaps and total score are accumlated. 
